...
class cart
{
    ...
    public function add_to_cart($id, $quantity)
    {
        ...
        if ($check) {
            $msg = 'Product already added into your cart';
            return $msg;
        } else {
            $query_insert = "INSERT INTO tbl_cart(productId, quantity, sId, price,image,productName) VALUES('$id',
            '$quantity', '$sId', ' $price','$image','$productName')";
    ...
    public function update_quantity_cart($cartId, $quantity)
    {
        ...
        if ($result) {
            ...
            $msg = "<span class='error'>Product's Quantity updated successfully</span>";
            return $msg;
        }
    }
    public function del_product_cart($cartId)
    {
        ...
        if ($result) {
            ...
            $msg = "<span class='error'>Product deleted not success</span>";
            return $msg;
        }
    }
    ...
    public function insertOrder($customer_id)
    {
        ...
        if ($get_product) {
            while ($result = $get_product->fetch_assoc()) {
                ...
                $query_order = "INSERT INTO tbl_order(productId, quantity, customer_id, price,image,productName) VALUES('$productid',
                '$quantity', '$customer_id', '$price','$image','$productName')";
    ...
    public function del_shipped($id, $time, $price)
    {
        ...
        if ($result) {
            ...
            $msg = "<span class='error'>Order deleted not successfully</span>";
            return $msg;
        }
    }
